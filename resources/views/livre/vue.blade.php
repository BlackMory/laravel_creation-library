                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <a href="{{route('livre.create')}}" >
                            <button type="button" class="btn btn-light" style="margin-left:1200px"> <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="white" class="bi bi-plus-square" viewBox="0 0 16 16">
                                    ...
                                    <tr>
                                        @foreach($livres as $livre)
                                            ...
                                            <td>{{$livre->editeur->nom}}</td>
                                               <td> <a href="/livre/show/{{$livre->id}}" class="btn btn-info" >lire</a>
                                            </td>
                                    </tr>
                                            @endforeach 
                                </tbody>
